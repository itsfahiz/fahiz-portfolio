...
List<Project> projectList = [
  ...
  Project(
    ...
    techStack: [
      ...
      'Local Storage (Hive, SharedPreferences)',
      'Firebase (Firestore, Cloud Messaging)',
      'AWS (Cognito, EC2, Lambda, S3)',
      'Node.js',
      'Express.js',
      'MongoDB',
      'Apache Kafka',
      'REST APIs',
      'Syncfusion Charts & Graphs',
      'HIPAA Compliance',
      'Jira',
      'Git',
      'Figma',
      'Bayshore Design System',
    ],
  ...
  Project(
    ...
    techStack: [
      ...
      'Go Router'
          'Clean Architecture',
      'Local Storage (Drift, Hive, SharedPreferences)',
      'Firebase (Firestore, Cloud Messaging)',
      'Microsoft OAuth 2.0',
      'JWT Token',
      'Aidbox FHIR',
    ...
    contentBlocks: [
      ...
      ContentBlock(
        ...
        bullets: [
          ...
          'Implemented structured routing with Go åRouter to maintain scalable and maintainable navigation flows across web and tablet versions.',
